...
public class Database {
    ...
    private Database() {
        try (InputStream input = new FileInputStream("Tourism-Agency-Management/src/Log/DBconfigure.properties")) {
    ...
    public static Connection connector() {
        ...
        Date date = new Date();
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("Tourism-Agency-Management/src/Log/dataLog.txt", true))) {
            try {

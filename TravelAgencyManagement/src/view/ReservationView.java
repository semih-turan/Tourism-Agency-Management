...
public class ReservationView extends Layout {
    ...
    public void searchTableLoad() {
        ...
        for (Search searchList : searchManager.findByAll()) {
            info = new Object[]{searchList.getRoom_seasson_id(), searchList.getRoom_id(), searchList.getHotel_id(), searchList.getHotel_name(),
                    searchList.getHotel_city(), searchList.getSeason_start_date(), searchList.getSeason_end_date(), searchList.getRoom_pansion_type(),
                    searchList.getRoom_stock_quantity(), searchList.getRoom_adult_price(), searchList.getRoom_child_price()};
    ...
    public void filterHotel() {
        ...
        btn_search.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ArrayList<Search> hotelTableList = searchManager.filterTable(selectedValueForCity, selectedValueForHotelName,
                ...
                for (Search searchList : hotelTableList) {
                    Object[] info = {searchList.getRoom_seasson_id(), searchList.getRoom_id(), searchList.getHotel_id(), searchList.getHotel_name(),
                            searchList.getHotel_city(), searchList.getSeason_start_date(), searchList.getSeason_end_date(), searchList.getRoom_pansion_type(),
                            searchList.getRoom_stock_quantity(), searchList.getRoom_adult_price(), searchList.getRoom_child_price()};
                    model.addRow(info);
                }
